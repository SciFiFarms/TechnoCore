...
alias run_esphome_wrapper='docker exec -it $(docker service ps -f desired-state=running --no-trunc ${stack_name:-technocore}_esphome | grep ${stack_name:-technocore} | tr -s " " | cut -d " " -f 2).$(docker service ps -f desired-state=running --no-trunc ${stack_name:-technocore}_esphome | grep ${stack_name:-technocore} | tr -s " " | cut -d " " -f 1) /bin/bash'
...
alias run_health='docker exec -it $(docker service ps -f desired-state=running --no-trunc ${stack_name:-technocore}_health | grep ${stack_name:-technocore} | tr -s " " | cut -d " " -f 2).$(docker service ps -f desired-state=running --no-trunc ${stack_name:-technocore}_health | grep ${stack_name:-technocore} | tr -s " " | cut -d " " -f 1) /bin/sh'
...
alias run_loki='docker exec -it $(docker service ps -f desired-state=running --no-trunc ${stack_name:-technocore}_loki | grep ${stack_name:-technocore} | tr -s " " | cut -d " " -f 2).$(docker service ps -f desired-state=running --no-trunc ${stack_name:-technocore}_loki | grep ${stack_name:-technocore} | tr -s " " | cut -d " " -f 1) /bin/sh'
alias run_promtail='docker exec -it $(docker service ps -f desired-state=running --no-trunc ${stack_name:-technocore}_promtail | grep ${stack_name:-technocore} | tr -s " " | cut -d " " -f 2).$(docker service ps -f desired-state=running --no-trunc ${stack_name:-technocore}_promtail | grep ${stack_name:-technocore} | tr -s " " | cut -d " " -f 1) /bin/sh'
...
alias run_timeseries_db='docker exec -it $(docker service ps -f desired-state=running --no-trunc ${stack_name:-technocore}_timeseries_db | grep ${stack_name:-technocore} | tr -s " " | cut -d " " -f 2).$(docker service ps -f desired-state=running --no-trunc ${stack_name:-technocore}_timeseries_db | grep ${stack_name:-technocore} | tr -s " " | cut -d " " -f 1) /bin/bash'
alias run_esphome='docker exec -it ${stack_name:-technocore}_esphome_app /bin/bash'
